...
base_dir=/home/nima/scratch/dual_rna/raw_reads

cat $base_dir/exp/ERR3419048.fastq $base_dir/exp/ERR3419051.fastq > $base_dir/experiment20/infection/SRR3419048.fastq
cat $base_dir/exp/ERR3419049.fastq $base_dir/exp/ERR3419052.fastq > $base_dir/experiment20/infection/SRR3419049.fastq
cat $base_dir/exp/ERR3419050.fastq $base_dir/exp/ERR3419053.fastq > $base_dir/experiment20/infection/SRR3419050.fastq


json_data=$(cat setup3.json)
